...
Patch7:         pulseaudio-07-padsp.diff
...
export CPPFLAGS="-D_XPG4_2 -D__EXTENSIONS__ -D__STDC__ -DBSD_COMP -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64"
...
%dir %attr (0755, root, bin) %{_datadir}/pulseaudio
%{_datadir}/pulseaudio/*
...
%attr (0755, root, sys) %{_sysconfdir}/xdg/autostart/pulseaudio.desktop
%attr (0755, root, sys) %dir %{_sysconfdir}/dbus-1
%attr (0755, root, sys) %dir %{_sysconfdir}/dbus-1/system.d
%attr (0755, root, bin) %{_sysconfdir}/dbus-1/system.d/pulseaudio-system.conf
