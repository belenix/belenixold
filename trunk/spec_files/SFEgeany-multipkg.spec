...
# =========================================================================== 
SUNW_Pkg: %{pkg_prefix}%{src_name}-%{base_arch}
...
export LDFLAGS="%_ldflags -L/usr/gnu/lib"
make -j$CPUS LIBS="-lintl -lsocket"
...
%changelog
* 2008.Apr.28 - <shivakumar dot gn at gmail dot com>
- Copied the spec from sfe to belenix trunk
- Bumped to V0.14
