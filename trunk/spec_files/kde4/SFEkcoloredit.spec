#
# spec file for package SFEkcoloredit
#
# includes module(s): kcoloredit
#
...
Source:                  http://gd.tuwien.ac.at/pub/kde/stable/%{kde_version}/src/extragear/kcoloredit-%{version}-kde%{kde_version}.tar.bz2
