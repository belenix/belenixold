#
# spec file for package SFEktorrent
#
# includes module(s): ktorrent
#
...
export CFLAGS="-march=pentium3 -fno-omit-frame-pointer -fPIC -DPIC -I%{gnu_inc} -I%{sfw_inc} -DSOLARIS -DUSE_SOLARIS -DNAME_MAX=_POSIX_NAME_MAX"
export CXXFLAGS="-march=pentium3 -fno-omit-frame-pointer -fPIC -DPIC -I%{gnu_inc} -I%{sfw_inc} -DSOLARIS -DUSE_SOLARIS -DNAME_MAX=_POSIX_NAME_MAX"
...
%changelog
* Fri Oct 02 2009 - Moinak Ghosh <moinakg<at>belenix(dot)org>
- Initial version.
