...
Name:                netbeans-uml
Summary:             NetBeans UML Modeler
Version:             6.5
Source:              http://dlc.sun.com.edgesuite.net/netbeans/6.5/final/zip/moduleclusters/netbeans-6.5-200811100001-ml-uml.zip
...
cd %{name}-%{version}-build
unzip %{SOURCE} 
mv 'uml6/modules/DoorsIntegrationFiles/Samples/Automated Teller Machine.etreq' 'uml6/modules/DoorsIntegrationFiles/Samples/Automated_Teller_Machine.etreq'
