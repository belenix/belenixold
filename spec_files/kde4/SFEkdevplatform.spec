#
# spec file for package SFEkdevplatform
#
# includes module(s): kdevplatform
#
...
%define src_dir          kdevplatform
%define                  kdevelop_version 3.9.95
Name:                    SFEkdevplatform
Summary:                 IDE application foundation libraries
Version:                 0.9.95
License:                 GPLv2
URL:                     http://www.kde.org/
Source:                  ftp://gd.tuwien.ac.at/kde/unstable/kdevelop/%{kdevelop_version}/src/kdevplatform-%{version}.tar.bz2
Patch1:                  kdevplatform-01-kompare_vers.diff
...
%description
KDevplatform is a free, opensource set of libraries that can be
...
export LDFLAGS="%_ldflags -lsocket -lnsl -L/lib -R/lib -L%{_prefix}/lib/svn -R%{_prefix}/lib/svn %{gnu_lib_path} -lstdc++ %{xorg_lib_path} %{sfw_lib_path}"
...
#
# Filenames with spaces can't be handled by SVR4 UGH!
#
(cd $RPM_BUILD_ROOT%{_datadir}/apps/kdevcodegen/licenses/
 mv "Apache v2" "Apache_v2"
 mv "GPL v2" "GPL_v2"
 mv "GPL v3" "GPL_v3"
 mv "LGPL v2" "LGPL_v2"
 mv "MIT X11" "MIT_X11"
 mv "Mozilla v1.1" "Mozilla_v1.1"
)
...
%{_includedir}/*
%dir %attr (0755, root, bin) %{_libdir}
%dir %attr (0755, root, bin) %{_libdir}/kdevplatform
%{_libdir}/kdevplatform/*
