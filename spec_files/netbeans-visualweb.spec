...
Name:                netbeans-visualweb
Summary:             Netbeans Visual Web Pack
Version:             6.5
Source:              http://dlc.sun.com.edgesuite.net/netbeans/6.5/final/zip/moduleclusters/netbeans-6.5-200811100001-ml-visualweb.zip

SUNW_BaseDir:        /
BuildRoot:           %{_tmppath}/%{name}-%{version}-build
Requires:            SUNWj6dev
Requires:            netbeans-base
Requires:            netbeans-enterprise
